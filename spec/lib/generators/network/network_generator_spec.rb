...
require 'support/examples/network_generator'

require 'generators/platforms/core/network/network_generator'

module Platforms
  module Core
    RSpec.describe NetworkGenerator, type: :generator do
      ...
      describe "run generator" do
        ...
        # New class
        it_behaves_like "network generator create" do
        ...
        # Existing class
        it_behaves_like "network generator patch" do
          let(:model_path) { "widget" }
        end
